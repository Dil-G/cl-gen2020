...
if (isset($_POST['requestCharacter'])) {
    ...
    if($userType == 'student'){
        ...
        $prefix = 'ST';
        $reqID = substr($userID,2);
        $studentID = $prefix . $reqID;
    }
    $reason = $_POST['reason'];
    ...
    for ($i = 0; $i < $countfiles; $i++) {
        ...
        if($ext !== 'jpg' && $ext !== 'jpeg' && $ext !== 'png' && $ext !== 'gif' && $ext !== 'pdf' ){
            ...
            if($userType == 'student'){
                ...
                header('Location: ../public/parent/character-form.php?error='.$error);
                exit();
            }
    ...
    $check_table = "SELECT * FROM characterrequests WHERE studentID='$studentID'";
    ...
    $requestStatus = 0;
    $sql = "INSERT INTO characterrequests (requestID,userID,studentID,reason,requestStatus,requestedDateTime) VALUES ('$requestID','$userID','$studentID','$reason','$requestStatus','$date');";
    ...
    if ($result == false|| $result1 == false){
        ...
        if($userType == 'student'){
            ...
            header('Location: ../public/parent/character-form.php');
        }
...
if (isset($_POST['issueCharacter'])) {
    ...
    for ($i = 0; $i < $countfiles; $i++) {
        ...
        if($ext !== 'jpg' && $ext !== 'jpeg' && $ext !== 'png' && $ext !== 'gif' && $ext !== 'pdf' ){
            ...
            if($userType == 'student'){
                ...
                header('Location: ../public/parent/newsfeed.php?error='.$error);
                exit();
            }
    ...
    $sql = "INSERT INTO characterissues (issueID,issue,userID,requestID,date_time) VALUES ('$issueID','$issue','$userID','$requestID','$date');";
...
if (isset($_GET['accepted'])) {
    ...
    echo $userID;
    $retreive = "SELECT * FROM characterrequests WHERE studentID='$studentID'";
    $result = mysqli_query($conn, $retreive);
    $row = mysqli_fetch_assoc($result);
    ...
    if ($row['requestStatus'] == '3') {
        ...
        if ($result1 == false){
            ...
            $msg = "Character certficate accepted";
            if($userType == 'student'){
                header('Location: ../public/student/character-form.php?msg='.$msg);
            }else{
                header('Location: ../public/parent/character-form.php?msg='.$mesg);
            }
...
if (isset($_POST['requestLeaving'])) {
    ...
    $check_table = "SELECT * FROM leavingrequests WHERE studentID='$studentID'";
    $check_result = mysqli_query($conn, $check_table);
    $date = date('Y-m-d H:i:s');
    ...
    $requestStatus = 0;
    $sql = "INSERT INTO leavingrequests (requestID,userID,studentID,reason,requestStatus,date_time) VALUES ('$requestID','$userID','$studentID','$reason','$requestStatus','$date');";
    $result =mysqli_query($conn,$sql);
...
if (isset($_POST['issueLeaving'])) {
    ...
    $requestStatus = 2;
    $sql = "INSERT INTO leavingissues (issueID,issue,userID,requestID,date_time) VALUES ('$issueID','$issue','$userID','$requestID','$date');";
...
//         $error = "Leaving Document Already accepted";
//        if($userType == 'student'){
//             header('Location: ../public/student/newsfeed.php?error='.$error);
//             exit();
//         }else{
...
if (isset($_GET['acceptedLeaving'])) {
    ...
    echo $userID;
    $retreive = "SELECT * FROM leavingrequests WHERE studentID='$studentID'";
    $result = mysqli_query($conn, $retreive);
    $row = mysqli_fetch_assoc($result);
