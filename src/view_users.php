...
if(!$teacher_result || !$teacher_result3){
    $error = "Cannot Retrieve Data";
}
else{
...
if(!$student_result || !$student_result2  ){
...
if(!$parent_result || !$parent_result1){
    $error = "Cannot Retrieve Data";
}
else{
...
$user_sql2 = "SELECT * FROM user WHERE isActivated = 1 AND userType != 'superadmin' limit $start_from,$num_per_page";
$user_res2=mysqli_query($conn,$user_sql2);

$number_sql = "SELECT * FROM user WHERE isActivated = 1 AND userType != 'superadmin'";
