><?php 
                                    ...
                                    echo"<a href='view_proof.php?proofid=".$row['proofID']."'>View File</a><br>"; } ?><br>
...
define ('../../extra/', realpath(dirname(__FILE__)));
...
$folder = "uploads/";
 ...
 for($i=0;$i<$countfiles;$i++){
  ...
  // Upload file
  $move = move_uploaded_file($tmpname,'../../extra/'.$filename);
...
?>
                                ...
                                //  header('Content-Type:'.$rr['fileType']);
                                   echo "<embed src='data:". $rr['fileType'].";base64,".base64_encode($rr['fileData'])."'width='500,'height='500/>"?>
                                     <!-- <object data="data:application/pdf;base64, -->
                                    <?php 
                                    // echo base64_encode($rr['fileData'])
                                     ?>
                                    <!-- " type="application/pdf" style="height:400px;width:60%"></object> -->
                                </div>
