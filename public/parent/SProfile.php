...
<?php
			...
			$sql1 = "SELECT * FROM student where admissionNo='$stuID' ";
							...
							<div class="col">
								<div class="form-group">
									...
									<input id="stunic" class="inputs" placeholder="NIC"
										value="<?php echo $row['stuNic'] ?>" type="text">
								</div>
							</div>
							<div class="col">
								<div class="form-group ">
							...
							<div class="col">
								<div class="form-group">
									...
									<input id="religion" class="inputs" placeholder="Religion"
										value="<?php echo $row['religion'] ?>" type="text">
								</div>
							</div>
						</div>
							...
							<div class="col">
								<div class="form-group ">
									...
									<input type="text" id="adNo" class="inputs" placeholder="Admission Number"
										value="<?php echo $row['admissionNo'] ?>">
								</div>
							</div>
							<div class="col">
								<div class="form-group ">
									...
									<input type="text" id="Edate" class="inputs" placeholder="Entered Date"
										value="<?php echo $row['enteredDate'] ?>">
								</div>
							</div>
							<div class="col">
								<div class="form-group">
									...
									<input type="text" id="Egrade" class="inputs" placeholder="Entered Grade"
										value="<?php echo $row['enteredGrade'] ?>">
								</div>
							</div>
						</div>
					...
					<div class="col">
						<div class="form-group">
							...
							<input id="street" class="inputs" placeholder="Home Address"
								value="<?php echo $row['adStreet'] ?>" type="text">
						</div>
					</div>
					<div class="col">
						<div class="form-group">
							...
							<input id="city" class="inputs" placeholder="Home Address"
								value="<?php echo $row['adCity'] ?>" type="text">
						</div>
					</div>
					<div class="col">
						<div class="form-group">
							...
							<input id="district" class="inputs" placeholder="Home Address"
								value="<?php echo $row['adDistrict'] ?>" type="text">
						</div>
					</div>
				</div>
				<div class="row">
