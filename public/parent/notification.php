      ...
      while ($row = mysqli_fetch_array($sql_noti)) { ?>
        <div class="container stu">
          ...
          <?php if (strpos($row['sendID'], 'CR') !== false) { ?>
            <button id="character-btn" class="registerbtn" name="accept"><?php echo "<a href = ../../src/characterRequest.php?accepted=" . $userID .  '&userType=' . $userType . " > Accept </a> " ?></button>
            <button id="character-btn" class="registerbtn" name="view_character"><?php echo "<a href = ../common/character_certificate_view.php?userID=" . $studentID .  " > View </a> " ?></button>
            <br>
            <button id="character-btn" class="cancel-btn" onclick="openCharacterForm()">Report Issue</button>
          <?php
          } else if (strpos($row['sendID'], 'LV') !== false) { ?>
            <button id="character-btn" class="registerbtn" name="accept"><?php echo "<a href = ../../src/characterRequest.php?acceptedLeaving=" . $userID . '&userType=' . $userType . " > Accept </a> " ?></button>
            <button id="character-btn" class="registerbtn" name="view_character"><?php echo "<a href = ../common/leaving_document.php?userID=" . $studentID . " > View </a> " ?></button>
            <br>
            <button id="character-btn" class="cancel-btn" onclick="openLeavingForm()">Report Issue</button>
          <?php
          } ?>
...
<div class="modal-content" style="margin-left: 120px;">
    <span class="close1 close_character" onclick="closeLeavingForm()">&times;</span>
    <h2>Leaving Issue Form</h2>
