                ...
                <table>
                    ...
                    <tbody id='Table'>
                        <tr>
                            ...
                            <?php echo "<td><a id='addExamBtn' class='btn editbtn' href = office_add_ALCsv.php?examID=".$row['examID']." > Add Results </a></td>" ?>
                            <?php echo "<td><a id='addExamBtn' class='btn viewbtn' href = office_viewAL_results.php?examID=".$row['examID']." > View Results </a></td>"?>
                        </tr>
                    </tbody>
                    <?php
                    }
