...
?>
    ...
    <title>Ordinary Level Subject Streams</title>
                ...
                <div id="addExamForm" class="model">
                    <div class="modal-content container">
                        <form action="../../src/o_addAl.php" method="POST">
                            <br>
                            <h1 style="color: #6a7480;">Ordinary Level Subject </h1>
                            <br>
                            <hr style="margin-left: 2%;">
                            <label for="ol-subject"><b> Subject Name</b></label>
                            <input type="text" placeholder="Enter Subject Name" name="olSubjectName" required>
                            <button type="submit" class="registerbtn" name="olsubjects">Save</button>
                            <a href="olsubjects.php" class="cancel-btn">Cancel</a>
