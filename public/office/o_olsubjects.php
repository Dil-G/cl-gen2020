...
<body>
    ...
    <div class="content">
        ...
        <div class="card">
            <div>
                <button id="addExamBtn" class="btn editbtn" type="submit" formaction="../../src/o_olsubjects.php">Add Subjects</button>
                <div id="addExamForm" class="model">
                    <div class="modal-content container">
                        <form action="../../src/o_olsubjects.php" method="POST">
                            <br>
                            ...
                            <a href="o_olsubjects.php" class="cancel-btn">Cancel</a>
