...
<body>
    ...
    <div class="content">
        ...
        <?php if (isset($_GET['error'])) { ?>
                        ...
                        <?php } ?>
            <div>
                <button id="addExamBtn" class="btn editbtn" type="submit" formaction="">Add New Stream</button>
                <div id="addExamForm" class="model">
                    <div class="modal-content container">
                        <form action="../../src/o_addAl.php" method="POST">
                            ...
                            <a href="office_al_streams.php" class="cancel-btn">Cancel</a>
            ...
            <table>
                ...
                <tr>
                    ...
                    <?php echo "<td><a id='addcsv' class='btn editbtn' href = office_al_subjects.php?streamID=".$row['streamID']." > Add Subjects </a></td>"
                    ?>
                   
                    <?php echo "<td><a class='btn viewbtn' href = office_streamDetails.php?streamID=".$row['streamID'].">View Subjects</td>" ?>
