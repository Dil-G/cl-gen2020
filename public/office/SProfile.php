                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" id="fname" class="inputs" placeholder="First name" value="Karate">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">

                                                    <input type="text" id="mname" class="inputs" placeholder="Middle name" value="Foot ball">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group ">

                                                    <input type="text" id="lname" class="inputs" placeholder="Last name" value="Cricket">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" id="fname" class="inputs" placeholder="First name" value="Volleyball">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">

                                                    <input type="text" id="mname" class="inputs" placeholder="Middle name" value="Netball">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group ">

                                                    <input type="text" id="lname" class="inputs" placeholder="Last name" value="Sumo">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island foot ball competition.">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island cricket competition.">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island sumo competition.">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" id="fname" class="inputs" placeholder="First name" value="Music society">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">

                                            <input type="text" id="mname" class="inputs" placeholder="Middle name" value="Girl Guide">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group ">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" id="fname" class="inputs" placeholder="First name" value="Sinhala Literature society">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">

                                            <input type="text" id="mname" class="inputs" placeholder="Middle name" value="Scrabble">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group ">

                                            <input type="text" id="lname" class="inputs" placeholder="Last name" value="Science">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    <label class="label" for="adNo">ID-01</label>
                                                    <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island balley dance competition.">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    <label class="label" for="adNo">ID-02</label>
                                                    <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island wild life competition.">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    <label class="label" for="adNo">ID-03</label>
                                                    <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island media competition.">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group ">
                                                    <label class="label" for="adNo">ID-04</label>
                                                    <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="Obtained first place in all island music competition.">
                                                </div>
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="fname" class="inputs" placeholder="First name" value="Katy">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label class="label" for="input-address">NIC</label>
                                                <input type="text" id="mname" class="inputs" placeholder="Middle name" value="Laura">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="adNo" class="inputs" placeholder="Admission Number" value="ST2000001">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" id="adNo" class="inputs" placeholder="Contact Number" value="ST2000001">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group ">
