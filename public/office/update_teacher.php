    ...
    <div class="content">
        <div class="container">
            <form action="../../src/register.php" method="POST" onsubmit="return validateRegistrations()">
                ...
                <label for="teacherType"><b>Teacher Type</b></label>
                
              
                <input type="text"  name="teacherType" id="teacherType"
                value="<?php if($row['teacherType'] == "classTcr"){
                        echo "Class Teacher";
                }else if($row['teacherType'] == "tcrinCharge"){
                    echo "Teacher in Charge";
                }else{
                ...
                <br>
                <br>
                <label> <input type="checkbox" name="checkbox[1]" id="t1" value="classTcr" <?php if($row['teacherType'] == "classTcr"){?> checked <?php } ?>> Class Teacher</label>
                <br>
                <br>
                <label> <input type="checkbox" name="checkbox[2]" id="t2" value="TcrinCharge" <?php if($row['teacherType'] == "tcrinCharge"){?> checked <?php } ?>> Teacher In charge</label>
