<<<<<<< HEAD:public/office/office_view_leaving_certificate_requests.php
<?php
session_start();
                    ...
                    <?php } ?>
                        ...
                        <table>
                            <tr>
                                ...
                                <th>Reason</th>
                                <th>Proof</th>
                                <th>Generate <br>Leaving Document</th>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <?php
                                        echo "<a class='btn editbtn' href = '../common/leaving_document.php?userID=" . $row['studentID'] . "' >View </a> " ?>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
...
<?php }
>>>>>>> 29f3e70bc5fc230c148413f61439af33a90a83b0:public/office/o_reqLc.php
} ?>