    ...
    <div class="content">
        <div class="container">
            <form action="../../src/register.php" method="POST" onsubmit="return validateRegistration()">
                ...
                <input type="text" placeholder="Enter ID" name="officerid" value="<?php if (isset($_GET['userID'])) {
																							echo $_GET['userID'];
																						} ?>" required>
                ...
                <input type="text" placeholder="Enter current address" name="address" id="street"
                ...
                <div>
                    ...
                    <a href="admin_staff.php" class="cancel-btn">Cancel</a>
