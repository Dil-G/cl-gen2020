...
?>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="card">
                <form>
                    <button type="submit" formaction="admin_addSociety.php">Add Society</button>
                </form>
                <hr>
                <div class="scroll">
                    <table>
                        ...
                        ?>
                            <tbody id="Table">
                                <tr>
                                    ...
                                    <?php
                                    // echo "<td><a class='btn editbtn' href = admin_updateSociety.php?societyID=" . $row['SocietyID'] . " > Update </a> </td>";
                                    ?>
