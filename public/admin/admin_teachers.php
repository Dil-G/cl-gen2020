...
<body>
    ...
    <div class="content">
        ...
        <div id="page1" class="page">
            <div class="card">
                <form>
                    <button class="viewbtn" type="submit" formaction="admin_registerUser.php">Add Teacher</button>
                </form>
					...
					?>
                        <tbody id="Table">
                            <tr>
                                ...
                                <?php echo "<td><a class='btn editbtn' href = admin_addTeacherDetails.php?userID=".$row['userID']." > Add </a> </td>"?>
                            </tr>
                            <?php
					}
					?>
                    ...
                    ?>
                        <tbody id="Table">
                            <tr>
                                ...
                                <?php echo "<td><a class='btn editbtn' href = admin_updateTeacher.php?userID=".$rows['teacherID']." > update </a> </td>"?>
