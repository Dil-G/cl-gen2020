...
<body>
    ...
    <div class="content">
        ...
        <div id="page1" class="page">
            <div class="card">
                <form>
                    <button class="viewbtn" type="submit" formaction="admin_registerUser.php">Add Student</button>
                </form>
                    ...
                    <table>
                        ...
                        <tbody id="Table">
                            <tr>
                                ...
                                <?php echo "<td><a class='btn editbtn' href = admin_addStudentDetails.php?studentID=" . $row['userID'] . " > Add </a> </td>" ?>
                            </tr>
                        </tbody>
                        <?php
                        }
                    ...
                    <table>
                        ...
                        <tbody id="Table">
                            <tr>
                                ...
                                <?php echo "<td><a class='btn editbtn' href = admin_updateStudent.php?userID=" . $rows['admissionNo'] . " > update </a> </td>" ?>
                                <td>
